...
<label class='{checked ? 'border-accent text-accent' : 'border-dark1 text-light1'} flex border-2 bg-dark1 cursor-pointer w-full items-center justify-center py-2 rounded-md hover:border-light1'>
